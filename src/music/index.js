...
const baseFreq = 440;  // A4 'main' note
const baseOffset = [4, 1];  // offset of base note from D0
...
class Music {
    ...
    static get intervals_semitones() {
        return intervals_semitones;
    }
...
class Interval {
    ...
    static fromTonesSemitones(tone_semitone) {
...
class Note {
    ...
    get latin() {
        let noteNames = ['F', 'C', 'G', 'D', 'A', 'E', 'B'];
        let accidentals = ['bb', 'b', '', '#', 'x'];
        let acc = this.accidental();
